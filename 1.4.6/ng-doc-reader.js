...
var pickValue = function(map, path) {
...
var getRedirectLocation = function(path) {
  var redirectMap = {
    '^/(?:docs/?)?$': '/docs/api'
  };
  return pickValue(redirectMap, path);
};

var getRealPath = function(path) {
  var fileMap = {
    '^/docs/api': '/docs/index.html',
    '^/docs/error': '/docs/index.html',
    '^/docs/misc': '/docs/index.html',
    '^/docs/tutorial': '/docs/index.html',
    '^/docs/guide': '/docs/index.html',
    '^/favicon.ico': '/docs/favicon.ico'
  };
  var realPath = __dirname + (pickValue(fileMap, path) || path);
  return realPath;
};

var server = function(req, res) {
  var pathname = url.parse(req.url).pathname;
  var redirectLocation = getRedirectLocation(pathname);
  if (redirectLocation) {
    return redirect(res, redirectLocation);
  }
  var realPath = getRealPath(pathname);
...
var httpPort = parseInt(process.argv[2], 10) || 3000;
